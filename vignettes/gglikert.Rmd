...
By default, Likert plots will be centered, i.e. displaying the same number of modalities on each side on the graph. When the number of modalities is odd, half of the "central" modality is displayed negatively et half positively.

It is possible to control where to center the graph, using the `cutoff` argument, representting the number of modalities to be displayed negatively: `2` to display the two fist modalities negatively and the others positively; `2.25` to display the two first modalities and a quarter of the third negatively.
