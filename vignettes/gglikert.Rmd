...
To compare answers by subgroup, you can alternatively map `.question` to facets,
and define a grouping variable for `y`.
...
`gglikert()`, `gglikert_stacked()` and `gglikert_data()` accepts a `weights`
