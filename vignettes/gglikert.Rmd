...
## gglikerts() and facets

You could use `gglikerts()` with facets, as long as totals are not displayed.
...
If you indicate `add_totals = TRUE`, you will not have an error. However, displayed totals will be computed overall, and not per facet.
