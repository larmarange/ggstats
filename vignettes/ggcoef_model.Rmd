...
vignette: >
  %\VignetteIndexEntry{Plot model coefficients}
...
Do not hesitate to consult the [help file](http://ggobi.github.io/ggally/reference/ggcoef_model.html) of `ggcoef_model()` to see all available options.
