...
The `ggstats` package provides a suite of functions to plot regression model coefficients ("forest plots") using `ggplot2`.

The suite includes new geometries to add alternating background color to a plot.

The original version of `gccoef_model()` was developed with the `{GGally}` package.
